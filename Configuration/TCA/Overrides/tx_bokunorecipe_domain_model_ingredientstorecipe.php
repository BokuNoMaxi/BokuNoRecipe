...
$GLOBALS['TCA']['tx_bokunorecipe_domain_model_ingredientstorecipe']['columns']['alternative_measurement']['config']['items']=[
        ...
        ['LLL:EXT:bokunorecipe/Resources/Private/Language/locallang_db.xlf:tx_bokunorecipe_bokunoingredients.alternativemessurement.package', 4],['LLL:EXT:bokunorecipe/Resources/Private/Language/locallang_db.xlf:tx_bokunorecipe_bokunoingredients.alternativemessurement.need', 5],
];
